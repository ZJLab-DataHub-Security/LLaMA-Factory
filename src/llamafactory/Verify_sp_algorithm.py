...
from easy_context import apply_lss_transformer_attn_monkey_patch_llama
...
def main():
    ...
    # sp model forward
    sp_result, sp_inters = sp_forward(model,dataset,tokenizer,algorithm_name="lss_transformer")
