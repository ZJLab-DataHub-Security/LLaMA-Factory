...
import transformers
from transformers.models.llama.modeling_llama import apply_rotary_pos_emb, BaseModelOutputWithPast, LlamaRotaryEmbedding
...
def apply_dist_flash_attn_monkey_patch_llama(sp_size=None):
    ...
    transformers.models.llama.modeling_llama.LlamaAttention.__init__ = new_LlamaAttention__init__
